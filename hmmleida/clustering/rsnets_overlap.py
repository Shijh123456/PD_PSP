...
def compute_overlap(centroids,parcellation=None,n_areas=None,set_negative_zero=True):
    """
...
def state_overlap(correlations,pvalues,k=2,state=1,plot=True,darkstyle=False,save_path=None):
    """
